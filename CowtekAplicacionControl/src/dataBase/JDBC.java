...
/**
 * 	Clase para crear la conexion con la db mediante usuario y contrase�a y leer las tablas 
 *  y vistas de la bd
 *  @author gorka
 *
 */
...
public class JDBC{
	...
	public JDBC(){
		this.userName = "aitorurrutia";
		this.password = "ondarru";
	}
	/**
	...
	/**
	 * Conexion a la bd mediante usuario y contrase�a
	 * @param user usuario
	...
	/**
	 * Conexion a BD con usuario y contrase�a ya preestablecidos
	...
	public List<VistaDatos> getVistaTempCorpVaca() {
		...
		try {
			...
			while (result.next()){			
				...
				vacas.add(new VistaDatos(vacaID, fechaHora, valor , "�C"));
			}
			conn.close();
		} catch (SQLException e) {
			// TODO Auto-generated catch block
